...
resolution = (750, 750) # Source video resolution
timepoint_len = 600 # Number of frames captured for each individual, per timepoint
...
for i, chunk in enumerate(chunks):
    ...
    proc = mp.Process(
        target=consume,
        args=(chunk, replicates_pg, frame_queue, frame_queue_id, request_queue),
    )
    proc.start()
